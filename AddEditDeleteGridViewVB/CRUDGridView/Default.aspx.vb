...
Partial Class _Default
    ...
    Protected Sub FillCustomerInGrid()
        ...
        Try
            ...
            Else 'if no record, display no record found in a new gridview cell
                ...
                GridView1.Rows(0).Cells(0).Text = "No hay registros de clientes"
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        If e.CommandName.Equals("AddNew") Then
            ...
            Dim cmbNewGender As TextBox
            cmbNewGender = CType(GridView1.FooterRow.FindControl("cmbNewGender"), TextBox)
            ...
            objCustomer.InsertCustomer(txtNewName.Text, cmbNewGender.Text, txtNewCity.Text, txtNewState.Text, cmbNewType.SelectedValue)
            FillCustomerInGrid()
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
        ...
        If (GridView1.EditIndex <> -1) Then
            ...
            Dim cmbGender As TextBox
            cmbGender = CType(GridView1.Rows(e.RowIndex).FindControl("cmbGender"), TextBox)
            ...
            objCustomer = New CustomerCls
            objCustomer.UpdateCustomer(txtName.Text, cmbGender.Text, txtCity.Text, txtState.Text, cmbType.SelectedValue)
            GridView1.EditIndex = -1
            FillCustomerInGrid()
        End If
