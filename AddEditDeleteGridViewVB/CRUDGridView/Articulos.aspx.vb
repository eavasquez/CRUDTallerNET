...
Partial Class _Default
    ...
    Dim objCustomer As ArticulosCls
    ...
    Protected Sub FillCustomerInGrid()
        ...
        Dim dtCustomer As DataTable = New ArticulosCls().Fetch()
        Try
            ...
            Else 'if no record, display no record found in a new gridview cell
                ...
                GridView1.Rows(0).Cells(0).Text = "NO hay registros en la base de datos"
    ...
    Protected Sub GridView1_RowUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewUpdateEventArgs)
        ...
        If (GridView1.EditIndex <> -1) Then
            ...
            objCustomer = New ArticulosCls
            objCustomer.UpdateCustomer(txtName.Text, cmbGender.SelectedValue, txtCity.Text, txtState.Text, cmbType.SelectedValue)
            GridView1.EditIndex = -1
            FillCustomerInGrid()
        End If
