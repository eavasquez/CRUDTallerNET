    ...
    <div id="Container">
        <div id="GridContainer">
            <div id="LabelContainer">
                <asp:Label ID="lblHeading" runat="server" Text="CRUD Clientes" >
                </asp:Label>
            </div>           
            <br />
               <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id, RUT" 
                ...
                CellPadding="0" ForeColor="#333333" CssClass="table table-striped table-bordered table-condensed">
                    <Columns>
                        <asp:TemplateField HeaderText="RUT">
                            <EditItemTemplate>
                                <asp:TextBox id="txtName" runat="server" Text='<%# Eval("RUT") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Nombre">
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("Nombre")%>' id="cmbGender"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("Nombre")%>' id="Label2"></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox ID="cmbNewGender" runat="server" ></asp:TextBox>
                            </FooterTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Apellido">
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("Apellido")%>' id="txtCity"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("Apellido")%>' id="Label3"></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Cargo">
                            <EditItemTemplate>
                                <asp:TextBox runat="server" Text='<%# Eval("Cargo")%>' id="txtState"></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" Text='<%# Eval("Cargo")%>' id="Label4"></asp:Label>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Eliminar" ShowHeader="False">
                            <ItemTemplate>        
                                <span onclick="return confirm('Seguro que quieres eliminar este cliente?')">
