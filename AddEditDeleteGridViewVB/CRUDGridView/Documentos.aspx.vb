...
Partial Class _Default
    ...
    Dim objCustomer As DocumentosCls
    ...
    Protected Sub FillCustomerInGrid()
        ...
        Dim dtCustomer As DataTable = New DocumentosCls().Fetch()
        Try
            ...
            Else 'if no record, display no record found in a new gridview cell
                ...
                GridView1.Rows(0).Cells(0).Text = "No hay registros de documentos"
